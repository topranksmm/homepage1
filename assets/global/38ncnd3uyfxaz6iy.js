...
var a = $.extend({}, !0, t);
"object" == typeof t && (t.beforeSend = function() {
"function" == typeof a.beforeSend && a.beforeSend();
}, t.success = function(e) {
i.request = null, void 0 !== t.type && t.type.toUpperCase() === "POST".toUpperCase() && (e.message && e.isSuper && i.notify({
0: {
type: void 0 !== e.type ? e.type : "danger",
text: e.message
}
}), e.reload) ? setTimeout(function() {
window.location.reload();
}, 2e3) : e.redirect && 0 < e.redirect.length ? window.location.replace(e.redirect) : "function" == typeof a.success && a.success(e);
}, null != i.request && i.request.abort(), i.request = $.ajax(t));
}, i.notify = function(e) {
var t, a;
...
}), a.auth && (window.localStorage && window.localStorage.setItem ? setTimeout(function e() {
...
}, 6e4)), $("#currencies-list #currencies-item").on("click", function(e) {
e.preventDefault();
var t = $(e.target).data(), e = a.csrftoken;
custom.ajax({
url: "/change-currency",
...
t.length && (e ? t.removeClass("hidden") : t.each(function() {
...
$.extend($.expr[":"], {
containsi(e) {
var t = e.innerHTML.match(/data-filter-table-service-name=\"true\"[^>]*>(.*?)<\/td>/is), a = e.innerHTML.match(/data-filter-table-service-id=\"([\d]+)\".*?/is), e = $(e).data("filter-table-category-id"), e = r && parseInt(e, 10) === parseInt(r, 10), t = t && t[1] && -1 !== t[1].toLowerCase().indexOf(n.toLowerCase()), a = a && a[1] && -1 !== a[1].toLowerCase().indexOf(n.toLowerCase());
return !(null !== r && !e || !t && !a);
}
}), o("clear"), $(e + " [data-filter-table-category-id]").not(`:containsi('${n.toLowerCase()}')`).each(function() {
$(this).addClass("hidden");
}), $(`${e} [data-filter-table-category-id]:containsi('${n.toLowerCase()}')`).each(function(e) {
$(this).removeClass("hidden");
}), n || null === r && $("[data-filter-table-category-id]").each(function(e) {
$(this).removeClass("hidden");
}), o();
}
var r = null, l = !1;
...
e.preventDefault();
var t = $(this).data("filter-category-id"), a = $(this).data("filter-category-name"), e = $("[data-search-service]").data().searchService;
void 0 !== t && ("All" === t ? (r = null, n(""), $("[data-filter-table-category-id]").removeClass("hidden"), 
o("clear"), l && i(l, e)) : ($("[data-filter-table-category-id]").addClass("hidden"), 
$(`[data-filter-table-category-id="${t}"]`).removeClass("hidden"), r = "" + t, n(a), 
o("clear"), l ? (o("clear"), i(l, e)) : o()));
}), $("[data-search-service]").keyup(function() {
var e = $(this).data("search-service"), t = e + " tr", a = $(this).val().toLowerCase();
1500 < $(t).length || i(l = a, e);
}), $(document).on("keypress", function(e) {
var t;
13 !== e.which || (t = $("[data-search-service]")).is(":focus") && (e = t.val(), 
t = t.data("search-service"), i(e, t));
}), $("[data-filter-serch-btn]").on("click", function() {
var e = $("[data-search-service]"), t = e.val(), e = e.data("search-service");
i(t, e);
});
});
}
...
var a = this.format, n = a.min;
e = this.toFixed(e);
var o = (e = $.trim(e.toString().replace(",", "."))).split(".");
void 0 !== o[1] && (o[1] = o[1].replace(/0+$/g, ""), o[1].length > n && (n = a.max < o[1].length ? a.max : o[1].length)), 
e = (e = 1e3 <= (e = (e = parseFloat(e)).toFixed(n)) ? e.replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1" + a.thousands) : e).replace(/\.(\d+)$/g, a.delimiter + "$1");
a = this.currencyOptions;
return e = (t ? a.original_template : a.template).replace("{{value}}", e);
},
getServicePriceByOrigin: function(e) {
var t = $("#orderform-service"), t = this.services[t.val()];
if (!t) return 0;
...
var e = this, t = $("#charge"), a = t.parent(".form-group"), n = $("#field-orderform-fields-quantity"), o = $("#orderform-service"), i = e.getMaxQuantityValue(), r = e.currencyOptions.converted;
if (a.show(), r && $(t).tooltip(), t.val(e.preparePrice(0)), e.services[o.val()]) {
var l = e.getServicePriceByOrigin(!1), d = e.getServicePriceByOrigin(!0), o = +e.getCurrentServiceType();
if (10 == o || 14 == o || 16 == o) return t.val(e.preparePrice(l)), void (r && $(t).attr("data-original-title", e.preparePrice(d, !0)));
if (100 != o) {
12 == o && $("#field-orderform-fields-check").prop("checked") && (n = $("#field-orderform-fields-total-quantity"));
n = $.trim(n.val());
return n && "" != n && n.length && !isNaN(n) && n.match(/^\d+$/gi) ? (n = parseInt(n), 
isNaN(n) ? (t.val(""), void (r && $(t).attr("data-original-title", ""))) : (l *= n = i < n ? i : n, 
d = d * n / 1e3, t.val(e.preparePrice(l /= 1e3)), void (r && $(t).attr("data-original-title", e.preparePrice(d, !0))))) : (t.val(""), 
...
e = "0." + new Array(t).join("0") + e.toString().substring(2)) : 20 < (t = parseInt(e.toString().split("+")[1])) && (t -= 20, 
e /= Math.pow(10, t), e += new Array(t + 1).join("0")), e;
},
